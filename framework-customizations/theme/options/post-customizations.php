...
$options = array(
	'customizations' => array(
		'title'   => esc_html__( 'Post Customizations', 'razz' ),
		'type'    => 'box',
		'options' => array(
			'meta-visibility' => array(
				'type'    => 'tab',
				'title'   => esc_html__( 'Post Options', 'razz' ),
				'options' => array(
					'post_cover'      => array(
						'type'    => 'multi-picker',
						'label'   => false,
						'picker'  => array(
							'control' => array(
								'type'         => 'switch',
								'value'        => 'off',
								'label'        => esc_html__( 'Post Cover', 'razz' ),
								'left-choice'  => array(
									'value' => 'off',
						...
						'choices' => array(
							'on' => array(
								'photo' => array(
									...
									'help'        => esc_html__( 'Minimum recommended size 1200px X 500px', 'razz' ),
									'desc'        => esc_html__( 'Upload cover photo with high resolution (1200px X 350px recommended as a minimum size) to display it as a background for the post title and meta', 'razz' ),
									'images_only' => true
								)
							)
						)
					...
					'top_banner'      => array(
						'type'         => 'switch',
						'value'        => 'on',
						'label'        => esc_html__( 'Top post banner', 'razz' ),
						'left-choice'  => array(
							'value' => 'off',
							'label' => esc_html__( 'Hide', 'razz' )
						),
					...
					'bottom_banner'   => array(
						'type'         => 'switch',
						'value'        => 'on',
						'label'        => esc_html__( 'Bottom post banner', 'razz' ),
						'left-choice'  => array(
							'value' => 'off',
							'label' => esc_html__( 'Hide', 'razz' )
						),
			...
			'body_box'        => array(
				'title'   => esc_html__( 'Post Background', 'razz' ),
				'type'    => 'tab',
				'options' => array(
					'body_background' => array(
						...
						'picker'  => array(
							'control' => array(
								'label'        => esc_html__( 'Post Background', 'razz' ),
								'type'         => 'switch',
								'inline'       => true,
								'value'        => 'off',
								'left-choice'  => array(
