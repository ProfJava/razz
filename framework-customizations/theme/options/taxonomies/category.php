...
if ( razz_get_setting( 'category_separate' ) ) {
	$options['banners'] = array(
		'title'   => esc_html__( 'Category Posts Layout', 'razz' ),
		'type'    => 'box',
		'options' => array(
			'cat_posts_layout' => array(
				'type'    => 'radio',
				'value'   => 'blog',
...
$options['cat_logo'] = array(
	'title'   => esc_html__( 'Category image', 'razz' ),
	'type'    => 'box',
	'options' => array(
		'image_select' => array(
			'type'        => 'upload',
			'label'       => esc_html__( 'Click to add image', 'razz' ),
			'images_only' => true
		)
	)
);
...
$options['body_box'] = array(
	'title'   => esc_html__( 'Category Background', 'razz' ),
	'type'    => 'box',
	'options' => array(
		'body_background' => array(
			...
			'picker'  => array(
				'control' => array(
					'label'        => esc_html__( 'Category Background', 'razz' ),
					'type'         => 'switch',
					'inline'       => true,
					'value'        => 'off',
					'left-choice'  => array(
