 ...
 */
class razz_recent_posts extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'razz_recent_posts', // Base ID
			RAZZ_THEME_NAME . esc_html__( ' Recent posts', 'razz' ), // Name
			array( 'description' => esc_html__( 'add recent posts widget', 'razz' ), ) // Args
		);
	}
