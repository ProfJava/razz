 ...
 */
class razz_most_viewed extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'razz_most_viewed', // Base ID
			RAZZ_THEME_NAME . esc_html__( ' Most viewed posts', 'razz' ), // Name
			array( 'description' => esc_html__( 'add most viewed posts widget', 'razz' ), ) // Args
		);
	}
