                    ...
                    <div class="blog-column">
						<?php if ( have_posts() ): while ( have_posts() ) : the_post(); ?>
                            <div itemscope itemtype="http://schema.org/Article" role="article"
								 ...
								 */
								get_template_part( 'templates/part', get_post_format() ); //Post format media
                                ...
                                <div style="display:none" class="vcard author" itemprop="author" itemscope
                                    ...
                                    <strong class="fn" itemprop="name"><?php the_author(); ?></strong>
                                </div>
								 ...
								 */
								if ( 'on' === razz_get_setting( 'tags_meta' ) or ! function_exists( 'fw_get_db_settings_option' ) ) {
								 ...
								 */
								if ( ( 'on' === razz_get_setting( 'share_posts' ) && 'off' !== razz_get_meta( get_the_ID(), 'share_posts' ) ) or ! function_exists( 'fw_get_db_settings_option' ) ) {
						...
						<?php endwhile;
							 ...
							 */
							if ( 'on' === razz_get_setting( 'related_posts_box/control' ) or 'off' !== razz_get_meta( get_the_ID(), 'single_related' ) ) {
								get_template_part( 'templates/related', 'posts' );
							}

							// Next and previous
							if ( 'off' !== razz_get_setting( 'nxt_prv_posts' ) ) { ?>
                                <div class="post-navigation">
                                    <div class="post-previous">
										<?php previous_post_link( '%link', '<span title="%title">' . esc_html__( 'Previous post', 'razz' ) . '</span>' ); ?>
                                    </div>
                                    <div class="post-next">
										<?php next_post_link( '%link', '<span title="%title">' . esc_html__( 'Next post', 'razz' ) . '</span>' ); ?>
                                    </div>
                                </div><!-- .post-navigation -->
							<?php }
